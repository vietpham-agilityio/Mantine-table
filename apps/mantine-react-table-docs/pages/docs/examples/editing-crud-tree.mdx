...
<Head>
  <title>{'Editing CRUD Tree Example - Mantine React Table V2 Docs'}</title>
  <meta
    name="description"
    content="An example of Mantine React Table which shows how to use editing CRUD features with expanding sub rows"
  />
  <meta
    property="og:title"
    content="Editing CRUD Tree Mantine React Table Example"
  />
  <meta
